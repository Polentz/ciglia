...
<body>
    ...
    <div class="page-label icon-wrapper">
        <span><?= $site->page()->title() ?></span>
        <svg id="scroller" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php if($site->page()->subtitle()->exists()) : ?>
            <span class="subtitle"><?= $site->page()->subtitle() ?></span>
        <?php endif ?>
    </div>