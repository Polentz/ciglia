...
<main class="main">
    ...
    <div class="audio-component">
        <div class="audio-player">
            ...
            <div class="play-btn">
                <svg class="play-icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="pause-icon"  width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
